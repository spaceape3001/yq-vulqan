...
namespace yq::tachyon {
    class InsertVertex³Command : public VertexCommand {
        YQ_OBJECT_DECLARE(InsertVertex³Command, VertexCommand)
    public:
        InsertVertex³Command(const Header&, size_t, const Vertex³&);
    ...
    protected:
        InsertVertex³Command(const InsertVertex³Command&, const Header&);
        virtual ~InsertVertex³Command();
    ...
    private:
        ...
        InsertVertex³Command(const InsertVertex³Command&) = delete;
        InsertVertex³Command(InsertVertex³Command&&) = delete;
        InsertVertex³Command& operator=(const InsertVertex³Command&) = delete;
        InsertVertex³Command& operator=(InsertVertex³Command&&) = delete;
    };
}
