...
#include <yq/asset/command/circular3/Circular3LockCommand.hpp>
#include <yq/asset/command/circular3/Circular3PeriodCommand.hpp>
#include <yq/asset/command/circular3/Circular3RadiusCommand.hpp>
#include <yq/asset/event/circular3/Circular3LockEvent.hpp>
#include <yq/asset/event/circular3/Circular3PeriodEvent.hpp>
#include <yq/asset/event/circular3/Circular3RadiusEvent.hpp>
...
#include <yq/tachyon/aspect/AOrientation3DWriter.hxx>
...
namespace yq::tachyon {
    ...
    CircularSpatial³::CircularSpatial³(const Param& p) : Spatial³(p), 
        APosition³D(p), AScale³D(p), AOrientation³D(p),
        m_angle0(p.angle0),
        m_locked(p.locked),
        m_period(p.period),
        m_radius(p.radius)
