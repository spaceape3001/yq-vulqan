...
namespace yq::tachyon {
    ...
    public:
        ...
        virtual Centimeter2D    position() const = 0;
        
        //!  Set position the position
        virtual void        position(set_k, const Centimeter2D&){}
        
        virtual void        position(set_k, x_k, Centimeter x){}
        virtual void        position(set_k, y_k, Centimeter y){}
        
        //!  Move the position (ie set to position + delta)
        virtual void        position(add_k, const Centimeter2D&Δ){}
