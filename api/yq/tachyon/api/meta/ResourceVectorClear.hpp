...
namespace yq::tachyon {
    ...
    */
    class ResourceVectorClear : public Meta {
    public:
    
        virtual std::error_code         clear(Object* obj) const = 0;
    ...
    protected:
        ResourceVectorClear(ResourceVectorProperty*, const std::source_location& sl);
    };
