...
namespace yq::tachyon {
    ...
    */
    class ResourceVectorEGet : public Meta {
    public:
        ...
        */
        virtual ResourceCPtr         get(const Object* obj, size_t) const = 0;
    ...
    protected:
        ResourceVectorEGet(ResourceVectorProperty*, const std::source_location& sl);
    };
}
