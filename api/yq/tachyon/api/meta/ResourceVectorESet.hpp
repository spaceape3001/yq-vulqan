...
namespace yq::tachyon {
    ...
    /*! \brief Abstract Element Setter (for resources on object)
        
        This is an abstract "getter" that may or may not have an object associated with it.
    */
    class ResourceVectorESet : public Meta {
    public:
    
        /*! \brief "Sets" the value for the meta
        ...
        */
        virtual std::error_code         set(Object* obj, size_t, const ResourceCPtr&) const = 0;
    ...
    protected:
        ResourceVectorESet(ResourceVectorProperty*, const std::source_location& sl);
    };
}
