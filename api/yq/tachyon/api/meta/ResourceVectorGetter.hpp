...
namespace yq::tachyon {
    ...
    */
    class ResourceVectorGetter : public Meta {
    public:
        ...
        */
        virtual ResourceCPtrVector           get(const Object* obj) const = 0;
    ...
    protected:
        ResourceVectorGetter(ResourceVectorProperty*, const std::source_location& sl);
    };
