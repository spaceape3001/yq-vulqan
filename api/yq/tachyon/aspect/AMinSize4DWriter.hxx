...
#include <yq/tachyon/aspect/AMinSize4D.hpp>
...
namespace yq::tachyon {
    ...
    void AMinSize⁴D::init_meta(TachyonMeta::Writer<C>&w)
    {
        ...
        w.slot(UNSAFE, &AMinSize⁴D::on_set_min_size4);
        w.slot(UNSAFE, &AMinSize⁴D::on_set_min_sizeW);
        ...
        w.slot(UNSAFE, &AMinSize⁴D::on_add_min_size4);
        w.slot(UNSAFE, &AMinSize⁴D::on_add_min_sizeW);
        ...
        w.slot(UNSAFE, &AMinSize⁴D::on_multiply_min_size4);
        w.slot(UNSAFE, &AMinSize⁴D::on_multiply_min_sizeW);
