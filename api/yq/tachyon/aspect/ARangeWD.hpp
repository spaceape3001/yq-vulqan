...
namespace yq::tachyon {
    ...
    class SetRangeʷDCommand;
    class SetRangeˣDCommand;
    class SetRangeʸDCommand;
    class SetRangeᶻDCommand;

    class ARangeʷD : public IRangeʷD, public virtual Tachyon::Helper {
    public:
    ...
    protected:
        ...
        ARangeʷD(const Param&p);
        ARangeʷD(const RangeD& r=ZERO);
        virtual ~ARangeʷD();
        
        void        w_range(emit_k);
        
    private:
        void        on_set_w_range(const SetRangeʷDCommand&);
    };
