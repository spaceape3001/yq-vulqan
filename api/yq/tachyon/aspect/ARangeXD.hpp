...
namespace yq::tachyon {
    ...
    class ARangeˣD : public IRangeˣD, public virtual Tachyon::Helper {
    public:
    ...
    protected:
        ...
        ARangeˣD(const Param&);
        ARangeˣD(const RangeD& r=ZERO);
        virtual ~ARangeˣD();
        
        void        x_range(emit_k);
        
    private:
        void        on_set_x_range(const SetRangeˣDCommand&);
    };
