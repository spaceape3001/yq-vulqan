...
namespace yq::tachyon {
    ...
    class ARangeᶻD : public IRangeᶻD, public virtual Tachyon::Helper {
    public:
    ...
    protected:
        ...
        ARangeᶻD(const Param&);
        ARangeᶻD(const RangeD& r=ZERO);
        virtual ~ARangeᶻD();
        
        void        z_range(emit_k);
        
    private:
        void        on_set_z_range(const SetRangeᶻDCommand&);
    };
