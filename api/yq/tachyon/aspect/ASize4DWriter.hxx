...
#include <yq/tachyon/aspect/ASize4D.hpp>
...
namespace yq::tachyon {
    ...
    void ASize⁴D::init_meta(TachyonMeta::Writer<C>&w)
    {
        ...
        w.slot(UNSAFE, &ASize⁴D::on_set_size4);
        w.slot(UNSAFE, &ASize⁴D::on_set_sizeW);
        w.slot(UNSAFE, &ASize⁴D::on_set_sizeX);
        w.slot(UNSAFE, &ASize⁴D::on_set_sizeY);
        w.slot(UNSAFE, &ASize⁴D::on_set_sizeZ);

        w.slot(UNSAFE, &ASize⁴D::on_add_size4);
        w.slot(UNSAFE, &ASize⁴D::on_add_sizeW);
        ...
        w.slot(UNSAFE, &ASize⁴D::on_multiply_size4);
        w.slot(UNSAFE, &ASize⁴D::on_multiply_sizeX);
        w.slot(UNSAFE, &ASize⁴D::on_multiply_sizeW);
