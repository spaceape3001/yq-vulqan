...
YQ_ENUM_IMPLEMENT(yq::tachyon::CompareOp)
YQ_ENUM_IMPLEMENT(yq::tachyon::ComponentSwizzle)
YQ_ENUM_IMPLEMENT(yq::tachyon::CullMode)
YQ_ENUM_IMPLEMENT(yq::tachyon::DataActivity)
YQ_ENUM_IMPLEMENT(yq::tachyon::DataFormat)
YQ_ENUM_IMPLEMENT(yq::tachyon::DrawMode)
YQ_ENUM_IMPLEMENT(yq::tachyon::DynamicState)
YQ_ENUM_IMPLEMENT(yq::tachyon::FrontFace)
YQ_ENUM_IMPLEMENT(yq::tachyon::GimbalMode)
YQ_ENUM_IMPLEMENT(yq::tachyon::HatState)
YQ_ENUM_IMPLEMENT(yq::tachyon::ImageAspect)
YQ_ENUM_IMPLEMENT(yq::tachyon::ImageLayout)
YQ_ENUM_IMPLEMENT(yq::tachyon::ImageTiling)
YQ_ENUM_IMPLEMENT(yq::tachyon::ImageViewCreateFlag)
...
YQ_ENUM_IMPLEMENT(yq::tachyon::PolygonMode)
YQ_ENUM_IMPLEMENT(yq::tachyon::PresentMode)
YQ_ENUM_IMPLEMENT(yq::tachyon::RasterType)
YQ_ENUM_IMPLEMENT(yq::tachyon::RenderMode)
YQ_ENUM_IMPLEMENT(yq::tachyon::Response)
YQ_ENUM_IMPLEMENT(yq::tachyon::SamplerAddressMode)
YQ_ENUM_IMPLEMENT(yq::tachyon::SamplerCreateFlag)
YQ_ENUM_IMPLEMENT(yq::tachyon::SamplerFilter)
YQ_ENUM_IMPLEMENT(yq::tachyon::SamplerMipmapMode)
YQ_ENUM_IMPLEMENT(yq::tachyon::SaveFlag)
YQ_ENUM_IMPLEMENT(yq::tachyon::SaveType)
YQ_ENUM_IMPLEMENT(yq::tachyon::ShaderType)
