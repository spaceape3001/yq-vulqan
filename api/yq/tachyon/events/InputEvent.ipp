...
namespace yq::tachyon {
    ...
    InputEvent::InputEvent(ViewerID v, const Param&p) : Event(p), ViewerBind(v), m_modifiers(p.modifiers)
    {
    }
    ...
    InputEvent::InputEvent(const Param& p) : Event(p), ViewerBind(p.viewer), m_modifiers(p.modifiers)
    {
    }
