...
namespace yq::tachyon {
    ...
    public:
        ...
        virtual Meter2D    position() const = 0;
        
        //!  Set position the position
        virtual void        position(set_k, const Meter2D&){}
        
        virtual void        position(set_k, x_k, Meter x){}
        virtual void        position(set_k, y_k, Meter y){}
        
        //!  Move the position (ie set to position + delta)
        virtual void        position(add_k, const Meter2D&Δ){}
