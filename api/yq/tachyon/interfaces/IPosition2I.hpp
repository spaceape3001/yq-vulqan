...
namespace yq::tachyon {
    ...
    public:
        ...
        virtual bool        position2i(disabled_k) const { return false; }
        virtual bool        position2i(settable_k) const { return false; }
        virtual bool        position2i(adjustable_k) const { return false; }
