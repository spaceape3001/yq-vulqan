...
#define tachyonFirstAlert(...)          yLogFirstAlert("tachyon", __VA_ARGS__)
#define tachyonFirstCritical(...)       yLogFirstCritical("tachyon", __VA_ARGS__)
#define tachyonFirstDebug(...)          yLogFirstDebug("tachyon", __VA_ARGS__)
#define tachyonFirstError(...)          yLogFirstError("tachyon", __VA_ARGS__)
#define tachyonFirstEmergency(...)      yLogFirstEmergency("tachyon", __VA_ARGS__)
#define tachyonFirstFatal(...)          yLogFirstFatal("tachyon", __VA_ARGS__)
#define tachyonFirstInfo(...)           yLogFirstInfo("tachyon", __VA_ARGS__)
#define tachyonFirstNotice(...)         yLogFirstNotice("tachyon", __VA_ARGS__)
#define tachyonFirstWarning(...)        yLogFirstWarning("tachyon", __VA_ARGS__)

#define tachyonOnceAlert                yLogOnceAlert("tachyon")             
#define tachyonOnceCritical             yLogOnceCritical("tachyon")          
#define tachyonOnceDebug                yLogOnceDebug("tachyon")             
#define tachyonOnceError                yLogOnceError("tachyon")             
#define tachyonOnceEmergency            yLogOnceEmergency("tachyon")         
#define tachyonOnceFatal                yLogOnceFatal("tachyon")             
#define tachyonOnceInfo                 yLogOnceInfo("tachyon")              
#define tachyonOnceNotice               yLogOnceNotice("tachyon")            
#define tachyonOnceWarning              yLogOnceWarning("tachyon")           
