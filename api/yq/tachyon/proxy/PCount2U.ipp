...
namespace yq::tachyon {
    ...
    void        PCount²U::count(set_k, const Vector2U& v) 
    {
    ...
    void        PCount²U::count(add_k, const Vector2U& Δ) 
    {
    ...
    void        PCount²U::count(multiply_k, const Vector2U& Δ) 
    {
        if(m_flags(F::Multipliable) && !m_flags(F::Disabled)){
