...
namespace yq::tachyon {
    ...
    void        PMaxSize³D::max_size(set_k, const Size3D& v) 
    {
    ...
    void        PMaxSize³D::max_size(add_k, const Size3D& Δ) 
    {
    ...
    void        PMaxSize³D::max_size(multiply_k, const Vector3D& Δ) 
    {
        if(m_flags(F::Multipliable) && !m_flags(F::Disabled)){
