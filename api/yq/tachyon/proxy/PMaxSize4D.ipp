...
namespace yq::tachyon {
    ...
    void        PMaxSize⁴D::max_size(set_k, const Size4D& v) 
    {
    ...
    void        PMaxSize⁴D::max_size(set_k, z_k, double z) 
    {
        if(m_flags(F::Settable) && !m_flags(F::Disabled)){
    ...
    void        PMaxSize⁴D::max_size(set_k, w_k, double w) 
    {
        if(m_flags(F::Settable) && !m_flags(F::Disabled)){
    ...
    void        PMaxSize⁴D::max_size(add_k, const Size4D& Δ) 
    {
    ...
    void        PMaxSize⁴D::max_size(add_k, z_k, double Δz) 
    {
        if(m_flags(F::Addable) && !m_flags(F::Disabled)){
    ...
    void        PMaxSize⁴D::max_size(add_k, w_k, double Δw) 
    {
        if(m_flags(F::Addable) && !m_flags(F::Disabled)){
    ...
    void        PMaxSize⁴D::max_size(multiply_k, const Vector4D& Δ) 
    {
        if(m_flags(F::Multipliable) && !m_flags(F::Disabled)){
    ...
    void        PMaxSize⁴D::max_size(multiply_k, z_k, double Δz) 
    {
        if(m_flags(F::Multipliable) && !m_flags(F::Disabled)){
    ...
    void        PMaxSize⁴D::max_size(multiply_k, w_k, double Δw) 
    {
        if(m_flags(F::Multipliable) && !m_flags(F::Disabled)){
