...
namespace yq::tachyon {
    ...
    void        PMinSize¹D::min_size(set_k, const Size1D& v) 
    {
    ...
    void        PMinSize¹D::min_size(add_k, const Size1D& Δ) 
    {
    ...
    void        PMinSize¹D::min_size(multiply_k, const Vector1D& Δ) 
    {
        if(m_flags(F::Multipliable) && !m_flags(F::Disabled)){
