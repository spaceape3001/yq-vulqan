...
namespace yq::tachyon {
    ...
    enum class VqAddressCopyBit : uint8_t {
        DeviceLocal = 1,
        Sparse = 2,
        Protected = 3
    };

    enum class VqAntiLagMode : int32_t {
        DriverControlAMD = 0,
        OnAMD = 1,
        OffAMD = 2
    };

    enum class VqAntiLagStage : int32_t {
        InputAMD = 0,
        PresentAMD = 1
    };
    ...
    enum class VqBuildAccelerationStructureBit : uint8_t {
        ...
        AllowDataAccess = 12,
        AllowClusterOpacityMicromaps = 13
    };
    ...
    enum class VqClusterAccelerationStructureAddressResolutionBit : uint8_t {
        IndirectedDstImplicitData = 1,
        IndirectedScratchData = 2,
        IndirectedDstAddressArray = 3,
        IndirectedDstSizesArray = 4,
        IndirectedSrcInfosArray = 5,
        IndirectedSrcInfosCount = 6
    };

    enum class VqClusterAccelerationStructureClusterBit : uint8_t {
        AllowDisableOpacityMicromaps = 1
    };

    enum class VqClusterAccelerationStructureGeometryBit : uint8_t {
        CullDisable = 1,
        NoDuplicateAnyhitInvocation = 2,
        Opaque = 3
    };

    enum class VqClusterAccelerationStructureIndexFormatBit : uint8_t {
        _8bit = 1,
        _16bit = 2,
        _32bit = 3
    };

    enum class VqClusterAccelerationStructureOpMode : int32_t {
        ImplicitDestinations = 0,
        ExplicitDestinations = 1,
        ComputeSizes = 2
    };

    enum class VqClusterAccelerationStructureOpType : int32_t {
        MoveObjects = 0,
    ...
    enum class VqClusterAccelerationStructureType : int32_t {
    ...
    enum class VqComponentType : int32_t {
        ...
        FloatE4m3 = Float8E4m3,
        FloatE5m2 = Float8E5m2
    };
    ...
    enum class VqCooperativeVectorMatrixLayout : int32_t {
        RowMajor = 0,
        ColumnMajor = 1,
    ...
    enum class VqDataGraphPipelinePropertyARM : int32_t {
        DataGraphPipelinePropertyCreationLogArm = 0,
        DataGraphPipelinePropertyIdentifierArm = 1
    };

    enum class VqDataGraphPipelineSessionBindPointARM : int32_t {
        DataGraphPipelineSessionBindPointTransientArm = 0
    };

    enum class VqDataGraphPipelineSessionBindPointTypeARM : int32_t {
    ...
    enum class VqDefaultVertexAttributeValue : int32_t {
        ZeroZeroZeroZero = 0,
        ZeroZeroZeroOne = 1
    };
    ...
    enum class VqDependencyBit : uint8_t {
        ...
        ViewLocal = 2,
        FeedbackLoop = 4,
        QueueFamilyOwnershipTransferUseAllStages = 6,
        AsymmetricEvent = 7
    };
    ...
    enum class VqDepthClampMode : int32_t {
        ViewportRange = 0,
        UserDefinedRange = 1
    };
    ...
    enum class VqDisplaySurfaceStereoType : int32_t {
        None = 0,
        OnboardDin = 1,
        Hdmi3d = 2,
        InbandDisplayport = 3
    ...
    enum class VqImageUsageBit : uint8_t {
        ...
        SampleWeight = 21,
        SampleBlockMatch = 22,
        TensorAliasingBitArm = 24,
        TileMemory = 28,
        VideoEncodeQuantizationDeltaMap = 26,
        VideoEncodeEmphasisMap = 27,
    ...
    enum class VqIndirectCommandsInputModeBit : uint8_t {
        VulkanIndexBuffer = 1,
        DxgiIndexBuffer = 2
    };
    ...
    enum class VqIndirectExecutionSetInfoType : int32_t {
        Pipelines = 0,
        ShaderObjects = 1
    };
    ...
    enum class VqObjectType : int32_t {
        ...
        Shader = 1000482000,
        PipelineBinary = 1000483000,
        DataGraphPipelineSessionArm = 1000507000,
        ExternalComputeQueue = 1000556000,
        IndirectExecutionSet = 1000572001
    };
    ...
    enum class VqPartitionedAccelerationStructureInstanceBit : uint8_t {
        FlagTriangleFacingCullDisable = 1,
        FlagTriangleFlipFacing = 2,
        FlagForceOpaque = 3,
        FlagForceNoOpaque = 4,
        FlagEnableExplicitBoundingBox = 5
    };

    enum class VqPartitionedAccelerationStructureOpType : int32_t {
        WriteInstance = 0,
        UpdateInstance = 1,
    ...
    enum class VqPhysicalDeviceDataGraphOperationTypeARM : int32_t {
        PhysicalDeviceDataGraphOperationTypeSpirvExtendedInstructionSetArm = 0
    };

    enum class VqPhysicalDeviceDataGraphProcessingEngineTypeARM : int32_t {
    ...
    enum class VqQueryPoolCreateBit : uint8_t {
        Reset = 1
    };
    ...
    enum class VqRayTracingLssIndexingMode : int32_t {
        List = 0,
        Successive = 1
    };

    enum class VqRayTracingLssPrimitiveEndCapsMode : int32_t {
        None = 0,
        Chained = 1
    };
    ...
    enum class VqRenderPassCreateBit : uint8_t {
        Transform = 2,
        PerLayerFragmentDensityBitValve = 3
    };
    ...
    enum class VqRenderingBit : uint8_t {
        ...
        ContentsInline = 5,
        PerLayerFragmentDensityBitValve = 6
    };
    ...
    enum class VqResolveModeBit : uint8_t {
        ...
        Min = 3,
        Max = 4,
        ExternalFormatDownsampleBitAndroid = 5,
    ...
    enum class VqTensorTilingARM : int32_t {
    ...
    enum class VqTileShadingRenderPassBit : uint8_t {
        Enable = 1,
        PerTileExecution = 2
    };
    ...
    enum class VqVideoEncodeAV1CapabilityBit : uint8_t {
        VideoEncodeAv1CapabilityPerRateControlGroupMinMaxQIndex = 1,
        VideoEncodeAv1CapabilityGenerateObuExtensionHeader = 2,
        VideoEncodeAv1CapabilityPrimaryReferenceCdfOnly = 3,
        VideoEncodeAv1CapabilityFrameSizeOverride = 4,
        VideoEncodeAv1CapabilityMotionVectorScaling = 5,
        VideoEncodeAv1CapabilityCompoundPredictionIntraRefresh = 6
    };

    enum class VqVideoEncodeAV1PredictionMode : int32_t {
    ...
    enum class VqVideoEncodeAV1RateControlBit : uint8_t {
        VideoEncodeAv1RateControlRegularGop = 1,
        VideoEncodeAv1RateControlTemporalLayerPatternDyadic = 2,
        VideoEncodeAv1RateControlReferencePatternFlat = 3,
        VideoEncodeAv1RateControlReferencePatternDyadic = 4
    };

    enum class VqVideoEncodeAV1RateControlGroup : int32_t {
    ...
    enum class VqVideoEncodeAV1StdBit : uint8_t {
        VideoEncodeAv1StdUniformTileSpacing = 1,
        VideoEncodeAv1StdSkipModePresentUnset = 2,
        VideoEncodeAv1StdPrimaryRefFrame = 3,
        VideoEncodeAv1StdDeltaQ = 4
    };

    enum class VqVideoEncodeAV1SuperblockSizeBit : uint8_t {
        VideoEncodeAv1SuperblockSize64 = 1,
        VideoEncodeAv1SuperblockSize128 = 2
    };
    ...
    enum class VqVideoEncodeH264CapabilityBit : uint8_t {
        ...
        BPictureIntraRefresh = 11,
        MbQpDiffWraparound = 10
    };
    ...
    enum class VqVideoEncodeH265CapabilityBit : uint8_t {
        ...
        BPictureIntraRefresh = 12,
        CuQpDiffWraparound = 11
    };
    ...
    enum class VqVideoEncodeIntraRefreshModeBit : uint8_t {
        PerPicturePartition = 1,
        BlockBased = 2,
        BlockRowBased = 3,
        BlockColumnBased = 4
    };
    ...
    enum class VqVideoEncodeRgbChromaOffsetFlagBitsVALVE : int32_t {
        VideoEncodeRgbChromaOffsetCositedEvenBitValve = 0x00000001,
        VideoEncodeRgbChromaOffsetMidpointBitValve = 0x00000002
    };

    enum class VqVideoEncodeRgbModelConversionFlagBitsVALVE : int32_t {
        VideoEncodeRgbModelConversionRgbIdentityBitValve = 0x00000001,
        VideoEncodeRgbModelConversionYcbcrIdentityBitValve = 0x00000002,
        VideoEncodeRgbModelConversionYcbcr709BitValve = 0x00000004,
        VideoEncodeRgbModelConversionYcbcr601BitValve = 0x00000008,
        VideoEncodeRgbModelConversionYcbcr2020BitValve = 0x00000010
    };

    enum class VqVideoEncodeRgbRangeCompressionFlagBitsVALVE : int32_t {
        VideoEncodeRgbRangeCompressionFullRangeBitValve = 0x00000001,
        VideoEncodeRgbRangeCompressionNarrowRangeBitValve = 0x00000002
    };
    ...
    enum class VqVideoSessionCreateBit : uint8_t {
        ...
        InlineQueries = 3,
        AllowEncodeQuantizationDeltaMap = 4,
        AllowEncodeEmphasisMap = 5,
        InlineSessionParameters = 6
    };

    enum class VqVideoSessionParametersCreateBit : uint8_t {
        QuantizationMapCompatible = 1
    };
    ...
    using VqAddressCopyFlags = Flags<VqAddressCopyBit>;
    ...
    using VqClusterAccelerationStructureAddressResolutionFlags = Flags<VqClusterAccelerationStructureAddressResolutionBit>;
    using VqClusterAccelerationStructureClusterFlags = Flags<VqClusterAccelerationStructureClusterBit>;
    using VqClusterAccelerationStructureGeometryFlags = Flags<VqClusterAccelerationStructureGeometryBit>;
    using VqClusterAccelerationStructureIndexFormatFlags = Flags<VqClusterAccelerationStructureIndexFormatBit>;
    ...
    using VqIndirectCommandsInputModeFlags = Flags<VqIndirectCommandsInputModeBit>;
    ...
    using VqPartitionedAccelerationStructureInstanceFlags = Flags<VqPartitionedAccelerationStructureInstanceBit>;
    ...
    using VqQueryPoolCreateFlags = Flags<VqQueryPoolCreateBit>;
    ...
    using VqTileShadingRenderPassFlags = Flags<VqTileShadingRenderPassBit>;
    ...
    using VqVideoEncodeAV1CapabilityFlags = Flags<VqVideoEncodeAV1CapabilityBit>;
    using VqVideoEncodeAV1RateControlFlags = Flags<VqVideoEncodeAV1RateControlBit>;
    using VqVideoEncodeAV1StdFlags = Flags<VqVideoEncodeAV1StdBit>;
    using VqVideoEncodeAV1SuperblockSizeFlags = Flags<VqVideoEncodeAV1SuperblockSizeBit>;
    ...
    using VqVideoEncodeIntraRefreshModeFlags = Flags<VqVideoEncodeIntraRefreshModeBit>;
    ...
    using VqVideoSessionParametersCreateFlags = Flags<VqVideoSessionParametersCreateBit>;
    ...
    std::string_view    to_string_view(VqAddressCopyBit);
    std::string_view    to_string_view(VqAntiLagMode);
    std::string_view    to_string_view(VqAntiLagStage);
    ...
    std::string_view    to_string_view(VqClusterAccelerationStructureAddressResolutionBit);
    std::string_view    to_string_view(VqClusterAccelerationStructureClusterBit);
    std::string_view    to_string_view(VqClusterAccelerationStructureGeometryBit);
    std::string_view    to_string_view(VqClusterAccelerationStructureIndexFormatBit);
    std::string_view    to_string_view(VqClusterAccelerationStructureOpMode);
    std::string_view    to_string_view(VqClusterAccelerationStructureOpType);
    std::string_view    to_string_view(VqClusterAccelerationStructureType);
    ...
    std::string_view    to_string_view(VqCooperativeVectorMatrixLayout);
    ...
    std::string_view    to_string_view(VqDataGraphPipelinePropertyARM);
    std::string_view    to_string_view(VqDataGraphPipelineSessionBindPointARM);
    std::string_view    to_string_view(VqDataGraphPipelineSessionBindPointTypeARM);
    ...
    std::string_view    to_string_view(VqDefaultVertexAttributeValue);
    std::string_view    to_string_view(VqDependencyBit);
    std::string_view    to_string_view(VqDepthBiasRepresentation);
    std::string_view    to_string_view(VqDepthClampMode);
    ...
    std::string_view    to_string_view(VqDisplaySurfaceStereoType);
    ...
    std::string_view    to_string_view(VqIndirectCommandsInputModeBit);
    ...
    std::string_view    to_string_view(VqIndirectExecutionSetInfoType);
    ...
    std::string_view    to_string_view(VqPartitionedAccelerationStructureInstanceBit);
    std::string_view    to_string_view(VqPartitionedAccelerationStructureOpType);
    ...
    std::string_view    to_string_view(VqPhysicalDeviceDataGraphOperationTypeARM);
    std::string_view    to_string_view(VqPhysicalDeviceDataGraphProcessingEngineTypeARM);
    ...
    std::string_view    to_string_view(VqQueryPoolCreateBit);
    ...
    std::string_view    to_string_view(VqRayTracingLssIndexingMode);
    std::string_view    to_string_view(VqRayTracingLssPrimitiveEndCapsMode);
    ...
    std::string_view    to_string_view(VqTensorTilingARM);
    std::string_view    to_string_view(VqTessellationDomainOrigin);
    std::string_view    to_string_view(VqTileShadingRenderPassBit);
    ...
    std::string_view    to_string_view(VqVideoEncodeAV1CapabilityBit);
    std::string_view    to_string_view(VqVideoEncodeAV1PredictionMode);
    std::string_view    to_string_view(VqVideoEncodeAV1RateControlBit);
    std::string_view    to_string_view(VqVideoEncodeAV1RateControlGroup);
    std::string_view    to_string_view(VqVideoEncodeAV1StdBit);
    std::string_view    to_string_view(VqVideoEncodeAV1SuperblockSizeBit);
    ...
    std::string_view    to_string_view(VqVideoEncodeIntraRefreshModeBit);
    std::string_view    to_string_view(VqVideoEncodeRateControlModeBit);
    std::string_view    to_string_view(VqVideoEncodeRgbChromaOffsetFlagBitsVALVE);
    std::string_view    to_string_view(VqVideoEncodeRgbModelConversionFlagBitsVALVE);
    std::string_view    to_string_view(VqVideoEncodeRgbRangeCompressionFlagBitsVALVE);
    ...
    std::string_view    to_string_view(VqVideoSessionParametersCreateBit);
